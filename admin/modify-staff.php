...
<?php
	...
	<a>Staff Name: </a><input type="text" name="staff_name" value="' . $fileArray[0] . '" required><br /><br />
	...
	echo '<a>Staff ID: </a><input width="20px" type="text" name="filename" value="' . $file . '" readonly><br />
	<input type="submit">
	</form><br />
